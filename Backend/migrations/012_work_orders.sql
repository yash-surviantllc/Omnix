...
-- Add indexes
CREATE INDEX IF NOT EXISTS idx_work_orders_po_id ON work_orders(production_order_id);
CREATE INDEX IF NOT EXISTS idx_work_orders_product_id ON work_orders(product_id);
CREATE INDEX IF NOT EXISTS idx_work_orders_status ON work_orders(status);
CREATE INDEX IF NOT EXISTS idx_work_orders_shift ON work_orders(shift);
...
-- Add indexes
CREATE INDEX IF NOT EXISTS idx_wo_materials_wo_id ON work_order_materials(work_order_id);
CREATE INDEX IF NOT EXISTS idx_wo_materials_material_id ON work_order_materials(material_id);

-- Add trigger for updated_at
CREATE TRIGGER update_work_order_materials_updated_at 
...
-- Add comments
COMMENT ON TABLE work_orders IS 'PO-based work orders with shift management';
COMMENT ON TABLE work_order_materials IS 'BOM-calculated material requirements for work orders';
