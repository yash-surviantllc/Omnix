...
async def update_order_status(
    ...
    """
    result = await purchase_order_service.update_order_status(order_id, status_data, current_user.id)
...
async def cancel_production_order(
    ...
    """
    return await purchase_order_service.cancel_production_order(order_id, current_user.id)
